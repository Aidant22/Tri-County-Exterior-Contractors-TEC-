...
export const metadata: Metadata = {
  title: "Landscaping in Toledo, OH — Tri-County Exterior Contractors",
  description: "Local Toledo landscaping and lawncare: mowing, mulching, cleanup serving Toledo and Lucas County. Free quotes — call 419-277-0435.",
};
    ...
    <div className="w-full">
      <section className="relative flex h-[calc(100vh-64px)] items-center justify-center px-4 text-center overflow-hidden">
        <Image
          ...
          alt="Lawncare in Toledo, OH by Tri-County Exterior Contractors"
          fill
          sizes="100vw"
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tight text-white drop-shadow-md">
            Landscaping in Toledo, OH
          </h1>
          <p className="text-base sm:text-xl text-slate-200 max-w-2xl mx-auto drop-shadow">
            Tri-County Exterior Contractors provides trusted lawncare and landscaping services throughout Toledo and Lucas County. We offer mowing, mulching, seasonal cleanups, and more.
          </p>
      ...
      <Script id="breadcrumb-toledo" strategy="afterInteractive" type="application/ld+json">
        {`{
          ...
          "itemListElement": [
            ...
            { "@type": "ListItem", "position": 3, "name": "Toledo", "item": "${process.env.NEXT_PUBLIC_SITE_URL || "https://tecexterior.com"}/locations/toledo" }
          ]
        }`}
      </Script>
      ...
      <section className="bg-slate-50 text-slate-900 py-20 px-4">
        <div className="max-w-6xl mx-auto space-y-8">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Local Lawncare Services for Toledo</h2>
          <p className="text-lg text-slate-600">
            We specialize in residential and small commercial landscaping tailored to Toledo homeowners. Our team focuses on fast response times, dependable scheduling, and delivering high-quality results every visit.
          </p>
